...
`версия 0.9 (beta)` · `Android (APK)` · `офлайн` · `бесплатно, без рекламы`
...
- 📚 **Библиотеки материалов** — Genki 1, Genki 2, «Полезные материалы»,. Возможность добавления своих библиотек. Расширение списка библиотек по популярным учебникам в будующем.
